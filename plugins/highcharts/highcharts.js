      ...
      y = (function () {
        ...
        e.prototype.destroy = function (c) {
          ...
          for (d in b.plotLinesAndBandsGroups)
            b.plotLinesAndBandsGroups[d] =
              b.plotLinesAndBandsGroups[d].destroy();
          x(b, function (c, e) {
        ...
        l = (function () {
          ...
          a.prototype.renderItem = function (a) {
            ...
            e ||
              ...
              (a.legendItem = e =
                g.text("", t ? k + f : -f, this.baseline || 0, w)),
          ...
          a.prototype.proximatePositions = function () {
            ...
            this.allItems.forEach(function (g) {
              ...
              if (g.yAxis) {
                ...
                g.points &&
                  (k = J(
                    l ? g.points : g.points.slice(0).reverse(),
                    function (d) {
                      return L(d.plotY);
                    }
                  ));
          ...
          a.prototype.handleOverflow = function (a) {
            ...
            a > l && !1 !== e.enabled
              ? ((this.clipHeight = p =
                  Math.max(l - 20 - this.titleHeight - f, 0)),
          ...
          drawGraph: function () {
            ...
            q.forEach(function (q) {
              ...
              p
                ...
                : ((I.zIndex = 0),
                  (p = a[v] =
                    a.chart.renderer.path(f).addClass(q[1]).add(a.group)),
                  (p.isArea = !0));
              a.chart.styledMode ||
                (I.fill = C(
                  q[3],
          ...
          drawPoints: function () {
            ...
            a.points.forEach(function (l) {
              ...
              if (v(l.plotY) && null !== l.y) {
                ...
                k ||
                  ((l.graphic = k =
                    q[l.shapeType](h).add(l.group || a.group)) &&
                    a.enabledDataSorting &&
                    f.hasRendered &&
                    f.pointCount < m &&
